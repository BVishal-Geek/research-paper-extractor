"""Parse PubMed Central JATS XML into a structured dict of sections + metadata."""
...
class XMLParser:
    ...
    def __init__(self):
        ...
        logger.info(
            f"XMLParser initialized with body_sections: {self.body_sections} "
            f"and special_sections: {self.special_sections}"
        )
